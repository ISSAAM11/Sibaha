            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <View style={styles.tableLines}>
                        ...
                        <View style={{flexDirection:"row",width:"100%",justifyContent: "space-between", }}>
                            <Text style={[styles.modalText,{fontWeight:'800'}]}>Languages</Text>
                        </View>
                        
                        <View style={ styles.underTitle }>
                            <Text style={{}}>Arabic </Text>
                            <BouncyCheckbox 
                                isChecked={props.languages.find(e => e == "Arabic")}
                                size={22}
                                style={styles.checkBox}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addLanguage("Arabic")}
                            />
                        </View>
                        <View style={ styles.underTitle }>
                            <Text style={{}}>English </Text>
                            <BouncyCheckbox 
                                isChecked={props.languages.find(e => e == "English")}
                                size={22}
                                style={styles.checkBox}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addLanguage("English")}
                            />
                        </View>
                        <View style={ styles.underTitle }>
                            <Text style={{}}>French</Text>
                            <BouncyCheckbox     
                                isChecked={props.languages.find(e => e == "French")}
                                size={22}
                                style={styles.checkBox}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addLanguage("French")}
                            />
                        </View>
                        
                        <View style={{flexDirection:"row",width:"100%",justifyContent: "space-between", }}>
                            <Text style={[styles.modalText,{fontWeight:'800'}]}>Catégiry</Text>
                        </View>

                        <View style={ styles.underTitle }>
                            <Text >Adult</Text>
                            <BouncyCheckbox     
                                isChecked={props.category.find(e => e == "Adult")}
                                style={styles.checkBox}
                                size={22}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addCategory("Adult")}
                            />                        
                        </View>
                        <View style={ styles.underTitle }>
                            <Text >kids</Text>
                            <BouncyCheckbox size={22}    
                                isChecked={props.category.find(e => e == "Kids")}
                                style={styles.checkBox}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addCategory("Kids")}
                            />
                        </View>
                        <View style={ styles.underTitle }>
                            <Text >Family</Text>
                            <BouncyCheckbox size={22}    
                                isChecked={props.category.find(e => e == "Family")}
                                style={styles.checkBox}
                                fillColor="#2196F3"
                                iconStyle={{ borderColor: "#2196F3" }}
                                innerIconStyle={{ borderWidth: 2 }}
                                onPress={()=> addCategory("Family")}
                            />
                        </View>
...
*/}
                        ...
                        <Pressable
                            ...
                            onPress={() => {props.setModalVisible(!props.modalVisible);console.log(props.category)
                                            props.forceUpdate()} }>
