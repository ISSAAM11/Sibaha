...
export default function AcademyDetails ({route, navigation}) {

    const { id, prix, title , description, location, favorite, image, latitude, longitude } = route.params;
                ...
                <View style={{marginHorizontal: 15}}>
                    <View style={styles.TitleView}>
                        <View style={{flexDirection: 'row', alignItems:'center', justifyContent: "space-between",}}>
                            ...
                            : <FontAwesome name="heart-o" size={22} color="#FF0000"/>} 
                        </View>
