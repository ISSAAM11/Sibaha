...
const MyAcademy = () => {
    ...
    let title = "Academy Unite"
    let description = "this is my description"
    let location = "Dubai marina";
    let latitude = 0.5511592
    let longitude = 0.5802124
    let image = "https://upload.wikimedia.org/wikipedia/commons/4/4a/Tunis_Piscine_olymique_Menzah_1.jpg"
    const DATA= [
        {
            id:1,
